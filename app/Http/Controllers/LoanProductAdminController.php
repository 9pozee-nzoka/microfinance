...
class LoanProductAdminController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'insurance_fee_rate'     => 'nullable|numeric|min:0|max:100',
            'late_penalty_rate'      => 'nullable|numeric|min:0|max:100',
            'grace_period_days'      => 'nullable|integer|min:0',
            'min_guarantors'         => 'nullable|integer|min:0',
            'min_savings_multiplier' => 'nullable|numeric|min:0',
            'requires_collateral'    => 'boolean',
            'collateral_type'        => 'nullable|in:none,land,vehicle,equipment,goods',
        ...
        $product = LoanProduct::create([
            ...
            'processing_fee_rate'    => $validated['processing_fee_rate'] ?? 0,
            'insurance_fee_rate'     => $validated['insurance_fee_rate'] ?? 0,
            'late_penalty_rate'      => $validated['late_penalty_rate'] ?? 0,
            'grace_period_days'      => $validated['grace_period_days'] ?? 0,
            'min_guarantors'         => $validated['min_guarantors'] ?? 0,
            'min_savings_multiplier' => $validated['min_savings_multiplier'] ?? 0,
            'requires_collateral'    => $request->boolean('requires_collateral'),
            'collateral_type'        => $validated['collateral_type'] ?? 'none',
            'min_membership_months'  => $validated['min_membership_months'] ?? 0,
