...
@section('title', 'My Reports - Mweela Cash Capital')
...
<style>
    ...
    .category-card:hover { transform: translateY(-3px); box-shadow: 0 8px 24px rgba(0,0,0,0.1); border-color: var(--primary); color: inherit; }
    .category-icon { width: 56px; height: 56px; border-radius: 12px; display: flex; align-items: center; justify-content: center; font-size: 24px; flex-shrink: 0; }
...
<div class="page-actions">
    <span style="font-size:12px; color:var(--text-secondary);">Reports scoped to your portfolio and customers</span>
</div>
...
<div class="card">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(320px, 1fr)); gap: 16px;">
        ...
        <a href="{{ route('staff.reports.categories.show', $category['slug']) }}" class="category-card">
